...
export const incidentDevices = pgTable(
  'incident_devices',
  {
...
export const deviceBackups = pgTable(
  'device_backups',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    deviceFk: uuid('device_fk')
...
export const officialSessions = pgTable(
  'official_sessions',
  {
...
export const officialSessionAuditLogs = pgTable(
  'official_session_audit_logs',
  {
    id: serial('id').primaryKey(),
    tenantId: uuid('tenant_id').notNull(),
    sessionGuid: text('session_guid')
